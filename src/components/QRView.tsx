...
/** URL pública de la carta (para QR y enlaces). */
const publicMenuUrl =
  typeof window !== 'undefined'
    ? `${window.location.origin}${window.location.pathname}#${ROUTES.PUBLIC}`
    : '';
    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6'>
      <div className='bg-white rounded-2xl shadow-2xl p-8 text-center max-w-md'>
        ...
        <div className='bg-gray-100 p-8 rounded-lg mb-6'>
          <div className='text-xs text-gray-500 mb-2'>URL de la carta (casa-cristobal):</div>
